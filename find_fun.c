...
/**
 * find_func - finds function at array and calls that function with args
 * @token_array: commands and arguments are stored
 * @y: line number
 * @node: node list to execute our functions
 */
void find_func(char *token_array[], int y, stack_t **node)
{
	...
	{"nop", NULL}, {"sub", sub}, {"div", _div}, {NULL, NULL}};
